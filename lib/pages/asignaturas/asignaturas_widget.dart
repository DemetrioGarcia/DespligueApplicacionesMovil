...
class _AsignaturasWidgetState extends State<AsignaturasWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.listaAsignatura = await actions.listarAsignaturas();
      _model.datos = _model.listaAsignatura!.toList().cast<dynamic>();
      safeSetState(() {});
    });
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          final listView =
                              _model.listaAsignatura!.map((e) => e).toList();

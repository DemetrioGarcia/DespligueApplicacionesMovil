      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: UserConfigWidget.routeName,
              path: UserConfigWidget.routePath,
              builder: (context, params) => UserConfigWidget(),
            ),
            FFRoute(
              name: AlbumWidget.routeName,
              path: AlbumWidget.routePath,
              builder: (context, params) => AlbumWidget(
                album: params.getParam<AlbumsRow>(
                  'album',
            ...
            FFRoute(
              name: CancionWidget.routeName,
              path: CancionWidget.routePath,
              builder: (context, params) => CancionWidget(
                cancion: params.getParam<TracksRow>(
                  'cancion',
                  ParamType.SupabaseRow,
                ),
              ),
